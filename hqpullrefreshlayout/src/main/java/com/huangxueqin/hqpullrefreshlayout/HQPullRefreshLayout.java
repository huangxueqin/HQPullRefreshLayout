package com.huangxueqin.hqpullrefreshlayout;
...
import com.huangxueqin.hqpullrefreshlayout.header.IRefreshHeader;
...
//        D("updateHeaderOnOffsetChange:, mState = " + mState + ", targetOffset = " + targetOffset);
...
//        D("scrollEnd: mTotalOffset = " + mTotalDraggedOffset);
    ...
    private void releaseDrag() {
        ...
        if (computeCurrentOffset() >= mRefreshOffset && mState == STATE_PULL_DOWN) {
            setState(STATE_REFRESHING);
